...
const DashboardChart = () => {
  const [chartType, setChartType] = useState<'participation' | 'departments' | 'trends'>('participation');
  ...
  return (
    <Card className="col-span-1 md:col-span-2">
      ...
      <CardContent>
        <Tabs 
          value={chartType} 
          onValueChange={(value) => setChartType(value as 'participation' | 'departments' | 'trends')}
          className="mt-2"
        >
          ...
          <TabsContent value="participation" className="h-[300px] mt-0">
          ...
          <TabsContent value="departments" className="h-[300px] mt-0">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
                  data={departmentData}
          ...
          <TabsContent value="trends" className="h-[300px] mt-0">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart
                data={monthlyData}
                margin={{ top: 10, right: 30, left: 0, bottom: 0 }}
